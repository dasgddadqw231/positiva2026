...
export function Footer({ lang }: { lang: 'KR' | 'EN' | 'TH' }) {
  return (
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-2 font-['Pretendard',sans-serif] font-medium text-sm text-[#858588] leading-relaxed">
              <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                <span>{lang === 'KR' ? "(주)대아트레이딩" : lang === 'TH' ? "บริษัท Daea Trading" : "Daea Trading Co., Ltd."}</span>
              ...
              <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                <span>{lang === 'KR' ? "고객센터: 070-8064-7732" : lang === 'TH' ? "ฝ่ายบริการ: 070-8064-7732" : "Customer Center: 070-8064-7732"}</span>
                <span className="w-px h-3 bg-[#47484c]" />
                <span>{lang === 'KR' ? "이메일: daeatrading@naver.com" : "Email: daeatrading@naver.com"}</span>
              </div>
              <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                <span>{lang === 'KR' ? "사업자등록번호: 809-81-03572" : lang === 'TH' ? "เลขทะเบียนธุรกิจ: 809-81-03572" : "Business Registration No.: 809-81-03572"}</span>
                <span className="w-px h-3 bg-[#47484c]" />
                <span>{lang === 'KR' ? "통신판매번호: 2025-서울강남-04890" : lang === 'TH' ? "ทะเบียนพาณิชย์อิเล็กทรอนิกส์: 2025-Seoul Gangnam-04890" : "E-commerce Permit: 2025-Seoul Gangnam-04890"}</span>
              </div>
            </div>
          </div>
        </div>
